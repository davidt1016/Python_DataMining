...
def WordColoring(freqWord):
	def coloring(word, font_size, position, orientation, random_state=None, **kwargs):
		return "hsl({}, {}%, {}%)".format(75, 100 * freqWord[word]/3, int(100.0 * freqWord[word] / 255.0))
	return coloring
...
wordcloud = WordCloud(width = 900, height = 900, max_words = 100, relative_scaling = 1, background_color = 'white').generate_from_frequencies(nltk_count)
...
wordcloud.to_file("/Users/davidteng/Desktop/WC1.png")
#wordcloud.to_file("/Users/davidteng/Desktop/WC2.png")
